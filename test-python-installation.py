...
def test_hyperspy():
    try:
        ...
        print("Could not import hyperspy -> hyperspy failed")
        return None
    #Simple test
    s = hs.load("G:\StardustResearch\SEM\Acfer3A_SEM\Acfer3ASmallCraterEMSA\Crater16(1)_pt1.emsa")
